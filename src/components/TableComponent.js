aaaaaaaqqqqqqqqqqqqqqqqqqqqqqqewqimport React, { useContext } from "react";
      ...
      <div className="flex flex-col mt-9 border border-gray-100 rounded">
        {cryptoData ? (
          ...
          <div className="w-full min-h-[50vh] flex justify-center items-center">
            <div
              className="w-8 h-8 border-4 border-solid border-[#ffc757] rounded-full border-b-gray-200 animate-spin"
              role="status"
            />
